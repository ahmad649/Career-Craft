...
import './../../css/recruiterPostedJobs.css'
                    ...
                    {jobs.map((job, index) => (
                        <div key={index} className='individual_job' onClick={event => handleIndividualJobClick(event,job)}>
                            ...
                            <div className='btnHolder'>
                                <button className='individual_job_btn' onClick={event => {event.stopPropagation(); handleEditPopup(event, job)}}>edit</button>
                                <button className='individual_job_btn' onClick={event => {event.stopPropagation(); onDelete(event, job._id)}}>delete</button>
                            </div>
